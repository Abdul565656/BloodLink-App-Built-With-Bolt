...
import { Heart, Users, Clock, Shield, Phone, Mail, MapPin, BarChart3, Droplets, Globe, Zap, Star, ArrowRight, CheckCircle, TrendingUp, Menu, X, Building2, ChevronDown } from 'lucide-react';
            ...
            {[
              ...
              return (
                <div key={index} className="text-center group">
                  <div className={`${colorClasses[item.color as keyof typeof colorClasses].split(' ')[2]} rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform group-hover:scale-105`}>
                    <div className={`bg-gradient-to-r ${colorClasses[item.color as keyof typeof colorClasses].split(' ')[0]} ${colorClasses[item.color as keyof typeof colorClasses].split(' ')[1]} p-4 rounded-2xl inline-block mb-4 group-hover:rotate-12 transition-transform duration-300`}>
